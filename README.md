...
| :--- | :--- | :--- |
| **[olcli](https://github.com/aloth/olcli)** [![npm](https://img.shields.io/npm/dm/@aloth/olcli)](https://www.npmjs.com/package/@aloth/olcli) [![GitHub stars](https://img.shields.io/github/stars/aloth/olcli)](https://github.com/aloth/olcli) | Overleaf CLI, library & MCP server — pull, push, sync, compile LaTeX projects from terminal, code, or AI agents. 14 MCP tools for Claude Desktop, Cursor & Windsurf. Available on [npm](https://www.npmjs.com/package/@aloth/olcli). Install as [AgentSkill](https://skills.sh/aloth/olcli/overleaf). | `TypeScript` `MCP` `Library` `CLI` |
